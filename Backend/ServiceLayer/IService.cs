...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    public interface IService
    {
        ...
        Response<SerivceUser> Login(string email, string password);
        ...
        Response<ServiceBoard> GetBoard(string email);
        ...
        Response<ServiceTask> AddTask(string email, string title, string description, DateTime dueDate);
        ...
        Response<ServiceColumn> GetColumn(string email, string columnName);
        ...
        /// <returns>A response object with a value set to the Column, The response should contain a error message in case of an error</returns>
        Response<ServiceColumn> GetColumn(string email, int columnOrdinal);
        ...
        /// <returns>A response object with a value set to the Column, the response should contain a error message in case of an error</returns>
        Response<ServiceColumn> AddColumn(string email, int columnOrdinal, string Name);
        ...
        /// <returns>A response object with a value set to the column, the response should contain a error message in case of an error</returns>
        Response<ServiceColumn> MoveColumnRight(string email, int columnOrdinal);
        ...
        /// <param name="columnOrdinal">Current location of the columns</param>
        /// <returns>A response object with a value set to the column, the response should contain a error message in case of an error</returns>
        Response<ServiceColumn> MoveColumnLeft(string email, int columnOrdinal);
